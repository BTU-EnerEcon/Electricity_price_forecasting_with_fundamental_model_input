...
*start-up parameters
    ...
    DownC(i,n,t)                shut down costs [EUR per MW]
...
*Hydro parameters
    ...
    wvf(t)                 watervalue factor based on price levels
...
$onecho > Import_general.txt
    ...
    par=priceup        rng=prices!N2:X7100           rdim=3 cdim=1
*    par=gaspriceup     rng=prices!AB2:BA4100         rdim=3 cdim=1

    par=techup         rng=Technology!B2:Q55   rdim=1 cdim=1
    par=CHP_net_production_up    rng=el_production_CHP!B2:AA66   rdim=2 cdim=1
...
* ------------   Loading Parameters     ---------------------
   ...
   fc(Gas,n,year,month,day)    = priceup(year,month,day,'Gas')        ;
*    fc(Gas,n,year,month,day)     = gaspriceup(year,month,day,n)          ;
    ...
    water_value_PSP_pump(n,i,t)   = sum( (month)$map_MT(month,t),  water_value_PSP_pump_up(n,i,month) *wvf(t) );
    water_value_PSP_gen(n,i,t)    = sum( (month)$map_MT(month,t),  water_value_PSP_gen_up(n,i,month)*wvf(t) )      ;
    water_value_Reservoir(n,i,t)  = sum( (month)$map_MT(month,t),  water_value_Reservoir_up(n,i,month)*wvf(t) );
...
%Before2015% af_tech_general(Thermal,n) = 0.87 ;
    ...
    CHP_gen_oil(n,t)        = sum((year)$map_YT(year,t), CHP_net_production_up(year,'oil',n))*1000 * CHP_total_factor_hourly(t,n)         ;
...
* vc_fl('coal_1','PL',t) = vc_fl('coal_1','DE',t)* 0.9 ;
* vc_fl('coal_2','PL',t) = vc_fl('coal_2','DE',t)* 0.9 ;
* vc_fl('coal_3','PL',t) = vc_fl('coal_3','DE',t)* 0.9 ;
* vc_fl('coal_4','PL',t) = vc_fl('coal_4','DE',t)* 0.9 ;

$ontext
parameter
neg_CHP;

neg_CHP(lignite,n,t) = cap(lignite,n,t)*0.8 - CHP_gen_coal_cluster(lignite,n,t);
neg_CHP(coal,n,t) = cap(coal,n,t)*0.8 - CHP_gen_coal_cluster(coal,n,t);
neg_CHP(gas,n,t) = cap(gas,n,t)*0.8 - CHP_gen_gas_cluster(gas,n,t);
neg_CHP(oil,n,t) = cap(oil,n,t)*0.8 - CHP_gen_gas_cluster(oil,n,t);
$offtext
